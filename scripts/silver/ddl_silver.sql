...
IF OBJECT_ID ('silver.crm_customers_details' , 'U') IS NOT NULL
	DROP TABLE silver.crm_customers_details;
CREATE TABLE silver.crm_customers_details (
...
IF OBJECT_ID ('silver.crm_geolocation' , 'U') IS NOT NULL
